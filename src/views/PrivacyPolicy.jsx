  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="text-lg leading-relaxed text-gray-800 dark:text-gray-300 space-y-6 prose dark:prose-invert">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-rose-900 dark:text-rose-700">
      ...
      <div className="mt-12 text-center">
        <Link
          href="/"
          className="inline-block px-6 py-3 bg-rose-900 text-white rounded-lg shadow-md hover:bg-rose-950 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-rose-900 focus:ring-offset-2 dark:focus:ring-offset-stone-900"
        >
