    ...
    <section className="bg-very-dark-gray text-white py-6 px-6 sm:px-12 lg:px-20">
      <div className="w-full max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
        <div className="max-w-xl text-center lg:text-left">
          <h1
            className="text-4xl sm:text-5xl font-bold leading-tight mb-2 uppercase tracking-wide font-serif"
            dangerouslySetInnerHTML={{ __html: t("hero_section.title") }}
          />
          <p className="text-lg text-gray-300">{t("hero_section.subtitle")}</p>
        </div>
        <Image
          src={whiteLogo}
